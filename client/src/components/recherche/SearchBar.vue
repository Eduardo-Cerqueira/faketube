    ...
    <div class="div-input w-2/5 mt-5 mx-auto relative">
      ...
      <div class="loop absolute inset-y-0 right-5 flex items-center">
        <button v-if="msg.length > 0" @click="clearmsg" class="p-4" id="cross-clear">
          <span
            class="absolute top-1/2 w-5 h-0.5 bg-gray-100 transform -translate-x-1/2 -translate-y-1/2 rotate-45"
          ></span>
          <span
            class="absolute top-1/2 w-0.5 h-5 bg-gray-100 transform -translate-x-1/2 -translate-y-1/2 rotate-45"
          ></span>
        </button>
    ...
    <div class="suggestion z-9999 bg-gray-700 mt-1 pr-15 rounded-xl w-2/5">
      <div v-for="content in filteredContent.slice(0, 4)" :key="content.text" class="max-h-16">
        <a
          ...
          ref="mySuggestions"
          href="{{ content.link }}"
          class="block items-center justify-center left-1 py-4"
        >
          <svg
            class="w-5 ml-4 px-0 mx-5 ml-0 ml-5"
            viewBox="0 0 20 20"
            fill="none"
            stroke="white"
            style="cursor: pointer"
          ...
          <span class="mx-5 h-12">{{ content.text }}</span
          ><br />
        </a>
      </div>
    </div>
...
const contents = ref([
  ...
  { text: 'cuisine facile', link: 'https://www.youtube.com/results?search_query=cuisine+facile' },
  {
    ...
    link: 'https://www.youtube.com/results?search_query=tutoriel+maquillage'
  },
  {
    text: 'yoga pour débutants',
    link: 'https://www.youtube.com/results?search_query=yoga+pour+débutants'
  },
  {
    text: 'exercices à la maison',
    link: 'https://www.youtube.com/results?search_query=exercices+à+la+maison'
  },
  {
    text: 'blagues hilarantes',
    link: 'https://www.youtube.com/results?search_query=blagues+hilarantes'
  },
  {
    text: 'jeux vidéo en ligne',
    link: 'https://www.youtube.com/results?search_query=jeux+vidéo+en+ligne'
  },
  {
    text: 'musique de relaxation',
    link: 'https://www.youtube.com/results?search_query=musique+de+relaxation'
  },
  {
    text: 'vidéos de chatons',
    link: 'https://www.youtube.com/results?search_query=vidéos+de+chatons'
  },
  {
    text: 'recettes végétariennes',
    link: 'https://www.youtube.com/results?search_query=recettes+végétariennes'
  },
  { text: 'humour noir', link: 'https://www.youtube.com/results?search_query=humour+noir' },
  {
    text: 'chansons de rap français',
    link: 'https://www.youtube.com/results?search_query=chansons+de+rap+français'
  },
  { text: 'astuces beauté', link: 'https://www.youtube.com/results?search_query=astuces+beauté' },
  {
    text: 'documentaires intéressants',
    link: 'https://www.youtube.com/results?search_query=documentaires+intéressants'
  },
  {
    text: "chansons d'amour",
    link: "https://www.youtube.com/results?search_query=chansons+d'amour"
  },
  {
    text: 'tutoriel coiffure',
    link: 'https://www.youtube.com/results?search_query=tutoriel+coiffure'
  },
  {
    text: 'recettes de cuisine asiatique',
    link: 'https://www.youtube.com/results?search_query=recettes+de+cuisine+asiatique'
  },
  { text: 'jeux de société', link: 'https://www.youtube.com/results?search_query=jeux+de+société' },
  {
    text: 'podcasts populaires',
    link: 'https://www.youtube.com/results?search_query=podcasts+populaires'
  },
  {
    text: 'conseils pour étudier',
    link: 'https://www.youtube.com/results?search_query=conseils+pour+étudier'
  }
])
const onkeyUp = () => {
  clear.value = true
