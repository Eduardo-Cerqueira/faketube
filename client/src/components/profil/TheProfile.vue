<template>
    ...
    <div class="flex flex-col items-center w-full mb-0">
      <label for="profile-image-input">
        <img
          ...
          class="w-[120px] h-[120px] object-cover mb-5 rounded-full border-4 border-white shadow-md cursor-pointer"
          alt="Profile Image"
        />
      </label>
      <input
      ...
      <button
        class="profile-logout-btn bg-red-600 mr-5 text-white rounded-md px-4 py-2 mt-4 transition-colors hover:bg-red-700"
        @click="logout"
      >
        Déconnexion
      </button>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="flex flex-col">
            ...
            <div class="flex items-center">
              ...
              <button
                class="profile-edit-btn bg-transparent text-gray-500 hover:text-gray-800 transition-colors ml-2"
                @click="editUsername"
              >
                Modifier
              </button>
  ...
  <div>
    ...
    <form class="flex flex-col space-y-4">
      <div class="flex flex-col">
        <label for="current-password" class="text-lg font-semibold mb-2"
        ...
        <input
          ...
          class="border border-gray-300 rounded-md py-2 px-3 text-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          required
        />
      </div>
      <div class="flex flex-col">
      ...
      <div class="flex flex-col">
        <label for="confirm-password" class="text-lg font-semibold mb-2"
